...
public class SpeechInterfaceBolinda
{
	private static SpeechSynthesizerBolinda mSynthesizer = null;
	...
	public static void initBolinda(String vocePath, boolean initSynthesis, 
			boolean initRecognition, String grammarPath, String grammarName)
		{
			...
			if (initSynthesis)
			{
		        ...
		        System.setProperty("mbrola.base", "C:\\Users\\RobertCyber\\git\\nebulus\\mbr301d");
		     		        
				mSynthesizer = new SpeechSynthesizerBolinda("mbrola_us2");
