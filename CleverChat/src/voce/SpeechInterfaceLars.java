...
public class SpeechInterfaceLars
{
	private static SpeechSynthesizerLars mSynthesizer = null;
	...
	public static void initLars(String vocePath, boolean initSynthesis, 
		boolean initRecognition, String grammarPath, String grammarName)
	{
		...
		if (initSynthesis)
		{
			...
			mSynthesizer = new SpeechSynthesizerLars("mbrola_us2");
		}
