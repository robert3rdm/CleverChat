...
public class SpeechSynthesizer
{
	...
	public SpeechSynthesizer(String name)
	{
		...
		Voice VoiceFemale = new Voice(name, 
			Voice.GENDER_FEMALE, Voice.AGE_YOUNGER_ADULT, null);
		Voice VoiceMale = new Voice(name, Voice.GENDER_MALE, 
		...
		{		
			...
			mSynthesizer.getSynthesizerProperties().setVoice(VoiceMale);
			mSynthesizer.getSynthesizerProperties().setPitch(350);
			mSynthesizer.getSynthesizerProperties().setSpeakingRate(150.0f);
			mSynthesizer.resume();
