...
public class SpeechSynthesizerLars
{
	...
	public SpeechSynthesizerLars(String name)
	{
		...
		{		
			...
			mSynthesizer.getSynthesizerProperties().setVoice(VoiceFemale);
			mSynthesizer.getSynthesizerProperties().setSpeakingRate(140.0f);
			mSynthesizer.resume();
